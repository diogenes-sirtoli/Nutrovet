...
namespace MaskEdit
{
	...
	public class MEdit : System.Web.UI.WebControls.TextBox
	{
		...
		public enum TpMascara
		{
			...
			String, Telefone, Celular, Titulo, CNPJ, Float, Inteiro, Hora, Money
		}
		...
		protected override void AddAttributesToRender(System.Web.UI.HtmlTextWriter writer)
		{
			switch (Mascara)
			{
				...
				case TpMascara.Celular:
					{
						writer.AddAttribute("onkeypress", "mascaraCelular(this);return Tecla(event);");
						MaxLength = 15;
						DesativaValor();
						break;
					}
