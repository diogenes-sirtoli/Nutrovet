<%@ Page Title="" Language="C#" MasterPageFile="~/AppMenuGeral.Master" AutoEventWireup="true"
    CodeBehind="RecBrancoUpdt.aspx.cs" Inherits="Nutrovet.Receituario.RecBrancoUpdt"
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        ...
                        <div class="col-lg-4">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>
                                        <i class="fas fa-prescription-bottle-alt fa-lg" aria-hidden="true"></i>
                                        <asp:Label ID="Label1" runat="server" Text=" Receita em Branco"></asp:Label>
                                    </strong>
                                </li>
                            </ol>
                        </div>
