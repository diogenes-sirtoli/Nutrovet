...
{
    public partial class RptNutraceut : System.Web.UI.Page
    {
        ...
        private void PopulaParametros(int _idRec, int idPessoa, int idCardapio)
        {
            ...
            BITotalIntervalosBll _intervalos = receituarioBll.TotalIntervalos(_idRec);
            ...
            ReportParameter prmInstrucoesReceita = new ReportParameter("prmInstrucoesReceita",
                receituarioDcl.InstrucoesReceita);
            ReportParameter prmTituloReceita = new ReportParameter("prmTituloReceita",
                receituarioDcl.Titulo);            
            ReportParameter prmVeiculo = new ReportParameter("prmVeiculo",
                receituarioDcl.Veiculo);
            ReportParameter prmQuantVeic = new ReportParameter("prmQuantVeic", 
                receituarioDcl.QuantVeic);
            ReportParameter prmPosologia = new ReportParameter("prmPosologia",
                receituarioDcl.Posologia);
            ReportParameter prmVeiculoTid = new ReportParameter("prmVeiculoTid",
                receituarioDcl.VeiculoTid);
            ReportParameter prmQuantVeicTid = new ReportParameter("prmQuantVeicTid",
                receituarioDcl.QuantVeicTid);
            ReportParameter prmPosologiaTid = new ReportParameter("prmPosologiaTid",
                receituarioDcl.PosologiaTid);
            ReportParameter prmVeiculoSid = new ReportParameter("prmVeiculoSid",
                receituarioDcl.VeiculoSid);
            ReportParameter prmQuantVeicSid = new ReportParameter("prmQuantVeicSid",
                receituarioDcl.QuantVeicSid);
            ReportParameter prmPosologiaSid = new ReportParameter("prmPosologiaSid",
                receituarioDcl.PosologiaSid);

            ReportParameter prmQtdTid = new ReportParameter("prmQtdTid",
                Funcoes.Funcoes.ConvertePara.String(Funcoes.Funcoes.ConvertePara.Int(
                    _intervalos.TotalTid)));
            ReportParameter prmQtdBid = new ReportParameter("prmQtdBid",
                Funcoes.Funcoes.ConvertePara.String(Funcoes.Funcoes.ConvertePara.Int(
                    _intervalos.TotalBid)));
            ReportParameter prmQtdSid = new ReportParameter("prmQtdSid",
                Funcoes.Funcoes.ConvertePara.String(Funcoes.Funcoes.ConvertePara.Int(
                    _intervalos.TotalSid)));
            ...
            List<ReportParameter> param = new List<ReportParameter>
            {
                ...
                prmImgLogo,
                prmImgAssin,
                prmInstrucoesReceita
            };

            rvRecNutra.LocalReport.EnableExternalImages = true;
            rvRecNutra.LocalReport.EnableHyperlinks = true;
            rvRecNutra.LocalReport.SetParameters(param);
            rvRecNutra.LocalReport.Refresh();
        }
        ...
        {
            byte[] pdfContent = rvRecNutra.LocalReport.Render(_tpImpr);
