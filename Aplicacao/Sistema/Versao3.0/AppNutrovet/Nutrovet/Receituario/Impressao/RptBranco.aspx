<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptBranco.aspx.cs"
    Inherits="Nutrovet.Receituario.Impressao.RptBranco" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <rsweb:ReportViewer ID="rvRecBranco" runat="server" Width="100%" BackColor=""
                ...
                <LocalReport ReportPath="Receituario\Impressao\rptBranco.rdlc">

                </LocalReport>
            </rsweb:ReportViewer>
        </div>
        <asp:ObjectDataSource ID="odcListaRecBranco" runat="server" SelectMethod="ListarImpressao" TypeName="BLL.clReceituarioNutrientesBll">
            <SelectParameters>
