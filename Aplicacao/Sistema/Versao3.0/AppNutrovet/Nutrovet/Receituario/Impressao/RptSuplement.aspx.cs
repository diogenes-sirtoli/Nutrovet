...
{
    public partial class RptSuplement : System.Web.UI.Page
    {
        ...
        private void PopulaParametros(int _idRec, int idPessoa, int idCardapio)
        {
            ...
            rvRecSupl.LocalReport.EnableExternalImages = true;
            rvRecSupl.LocalReport.EnableHyperlinks = true;
            rvRecSupl.LocalReport.SetParameters(param);
            rvRecSupl.LocalReport.Refresh();
        }
        ...
        {
            byte[] pdfContent = rvRecSupl.LocalReport.Render(_tpImpr);
