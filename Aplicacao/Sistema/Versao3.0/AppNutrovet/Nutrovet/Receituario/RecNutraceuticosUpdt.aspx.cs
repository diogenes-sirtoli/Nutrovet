...
{
    public partial class RecNutraceuticosUpdt : System.Web.UI.Page
    {
            ...
            else
            {
                if (!Page.IsPostBack)
                {
                    ...
                    if (_idReceita > 0)
                    {
                        ...
                        PopulaNutraceuticosReceita(_idReceita);
                    }
                    else
                    {
        ...
        private void PopulaTela(int _idReceita, int _idPessoa)
        {
            ...
            tbVeiculoBID.Text = receituarioDcl.Veiculo;
            tbQuantBID.Text = receituarioDcl.QuantVeic;
            tbPosolBID.Text = receituarioDcl.Posologia;
            tbVeiculoTID.Text = receituarioDcl.VeiculoTid;
            tbQuantTID.Text = receituarioDcl.QuantVeicTid;
            tbPosolTID.Text = receituarioDcl.PosologiaTid;
            tbVeiculoSID.Text = receituarioDcl.VeiculoSid;
            tbQuantSID.Text = receituarioDcl.QuantVeicSid;
            tbPosolSID.Text = receituarioDcl.PosologiaSid;
                    ...
                    if (ValidaItensRepeater(rptReceitaNutrac))
                    {
                        ...
                        else
                        {
                            Funcoes.Funcoes.Toastr.ShowToast(this,
                                ...
                                "É Necessário Selecionar uma Receita de Nutracêuticos!!!",
                                "NutroVET Informa - Alteração",
        ...
        private void PopulaLinksImpressao(DCL.Receituario _receita, TOCardapioBll _cardapioTO)
        {
            ...
            string url = string.Format($@"~/Receituario/Impressao/RptNutraceut.aspx?_idRec={
