<%@ Page Title="" Language="C#" MasterPageFile="~/AppMenuGeral.Master" AutoEventWireup="true"
    CodeBehind="RecSuplementacao.aspx.cs" Inherits="Nutrovet.Receituario.RecSuplementacao"
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div>
                    <div class="ibox-title">
                        <h5>
                            <asp:Label ID="lblSubTitulo" runat="server" Text="Receituário de Suplementação"></asp:Label>
                        </h5>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="col-sm-12">
                                                    ...
                                                    <strong><asp:Label ID="lblPeso" runat="server" class="control-label text-left" Text="Label"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-sm-8 b-r">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="x_content table-responsive">
                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        <asp:Repeater ID="rptReceitaSupl" runat="server" OnItemDataBound="rptReceitaSupl_ItemDataBound" OnItemCommand="rptReceitaSupl_ItemCommand">
                                                            <HeaderTemplate>
                                                                <thead>
                                                                    <tr>
                                                                        <th style="width: 15%">
                                                                            <asp:Label ID="lblIncldiet" runat="server" Text="Incluir na Receita"></asp:Label>
                                                                        </th>
                                                                        <th style="width: 40%">
                                                                            <asp:Label ID="lblNutr" runat="server" Text="Nutriente"></asp:Label>
                                                                        </th>
                                                                        <th style="width: 15%">
                                                                            <asp:Label ID="lblConsta" runat="server" Text="Consta na Dieta"></asp:Label>
                                                                        </th>
                                                                        <th style="width: 10%">
                                                                            <asp:Label ID="lblFalta" runat="server" Text="Falta"></asp:Label>
                                                                        </th>
                                                                        <th style="width: 10%">
                                                                            <asp:Label ID="lblDose" runat="server" Text="Dose"></asp:Label>
                                                                        </th>
                                                                        <th style="width: 10%">Ação
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblConstaReceita" runat="server" Text='<%# Eval("Consta") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblFaltaReceita" runat="server" Text='<%# Eval("Falta") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblDoseReceita" runat="server" Text='<%# Eval("Dose") %>'></asp:Label>
                                                                        <cc1:MEdit ID="meQtdFalta" runat="server" Text='<%# Eval("Dose") %>' placeholder="Quantidade que Falta" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Quantidade que Falta na Receita" Mascara="Float" Visible="False"></cc1:MEdit>
                                                                    </td>
                                                                    <td>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <asp:TextBox ID="tbxVeicExcip" ClientIDMode="Static" runat="server" placeholder="Veículo Excipiente" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Veículo Excipiente" MaxLength="100"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-4">
                                                <h5>
                                                    <asp:Label ID="lbQuantidadeVeiculoReceita" runat="server" class="col-lg-12 control-label text-left" Text="Quantidade"></asp:Label>
                                                </h5>
                                                <asp:TextBox ID="tbxQtdExcip" runat="server" placeholder="Quantidade do Veículo" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Quantidade"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <FTB:FreeTextBox ID="ftbPosologia" runat="server" AllowHtmlMode="False"
