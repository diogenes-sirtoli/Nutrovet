<%@ Page Title="" Language="C#" MasterPageFile="~/AppMenuGeral.Master" AutoEventWireup="true"
    CodeBehind="RecNutraceuticos.aspx.cs" Inherits="Nutrovet.Receituario.RecNutraceuticos"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <script>
        ...
        function atualizaTotal(txtDose) {
            ...
            /*var partes = celulaPesoPet.split('.');*/
            var celulaQuantidade = celulaDose.nextSibling.nextSibling.nextSibling.nextSibling/*.nextSibling.nextSibling*/;
            ...
            //var celulaDoseMaxima = parseFloat(celulaDose.previousSibling.previousSibling.innerText.replace('mg/Kg', '').replace('mg/kg', '').replace(',', '.'));
            //var celulaDoseMinima = parseFloat(celulaDose.previousSibling.previousSibling.previousSibling.previousSibling.innerText.replace('mg/Kg', '').replace('mg/kg', '').replace(',', '.'));
            ...
            /*var pesoPet = parseFloat(partes[0].replace(',', '.')) + parseFloat(partes[1].replace(',', '.')) / 100;*/
            var quantidade = null;
            ...
            if (!isNaN(dose)) {
                ...
                if (dose > 0/*>= celulaDoseMinima && dose <= celulaDoseMaxima*/) {
                    quantidade = dose * 1;
