...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script>
            window.onload = function () {
                // Chama a função chamarIzi assim que a página carregar
                chamarIzi();

            // Adiciona o evento de clique para o link de funcionalidades
            document.getElementById('funcionalidadesMenu').addEventListener('click', function (event) {
                event.preventDefault(); // Evita o comportamento padrão do link
            window.location.href = 'http://localhost/Nutrovet30/PortalNutrovet.aspx?scrollTo=features';
        });
    };
    ...
    <nav id="main-nav" class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <img src="Imagens/logo.png" alt="logo" onclick="location.href='https://www.nutrovet.com.br'" />
            </div>
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a id="portalMenu" data-toggle="collapse" data-target=".in" href="https://www.nutrovet.com.br"><i class="fa fa-home"></i>&nbsp;Início</a></li>
                    <li><a id="planoMenu" data-toggle="collapse" data-target=".in" href="./Plano/EscolherAssinatura.aspx"><i class="fas fa-handshake"></i>&nbsp;Planos</a></li>
            ...
            <div class="col-sm-8 col-sm-offset-3">
                <div class="login-box clearfix flipInY">
                    <div class="page-icon animated flip">
                        <asp:Image ID="imgUserIcon" src="Imagens/user-icon.png" runat="server" />
                    </div>
                    ...
                    <div class="login-form">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <!-- End Error box -->
                                <asp:TextBox ID="tbUser" placeholder="Usuário" CssClass="input-field" required="true" runat="server"></asp:TextBox>
    ...
    <div id="modal-demo" class="iziModal">
        No dia 19 de fevereiro às 22:00<br />
        o Sistema NUTROVET irá realizar uma breve parada<br />
        para realizar uma manutenção no servidor da aplicação.
    </div>
