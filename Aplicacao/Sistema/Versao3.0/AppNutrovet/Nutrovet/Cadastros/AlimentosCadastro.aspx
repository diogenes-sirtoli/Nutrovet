<%@ Page Title="Nutrologia Veterinária - NutroVET" Language="C#" MasterPageFile="~/AppMenuGeral.Master"
    AutoEventWireup="true" CodeBehind="AlimentosCadastro.aspx.cs"
    Inherits="Nutrovet.Cadastros.AlimentosCadastro" ValidateRequest="false" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <asp:HyperLink ID="hlAlimentos" NavigateUrl="~/Cadastros/AlimentosSelecao.aspx" runat="server"><i class="fas fa-utensils"></i> <strong>Alimentos</strong></asp:HyperLink>
                    </li>
                    <li class="active">
                        <strong>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <asp:DropDownList ID="ddlGrupo" class="form-control m-b" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <asp:DropDownList ID="ddlCategoria" class="form-control m-b" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <asp:TextBox ID="tbAlimento" class="form-control m-b" placeholder="Alimento" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-lg-2 control-label ">Compartilhar? </label>
                            <div class="btn-group col-lg-6 " role="group" aria-label="...">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-lg-2 control-label ">Usar Apelido para este Alimento? </label>
                            <div class="btn-group col-lg-6 " role="group" aria-label="...">
                                <asp:Button ID="btnAlsSim" runat="server" CssClass="btn btn-default" Text="Sim" OnClick="btnAlsSim_Click" />
                                <asp:Button ID="btnAlsNao" runat="server" CssClass="btn btn-primary-nutrovet" Text="Não" OnClick="btnAlsNao_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="row" id="divAlias" runat="server" visible="false">
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Apelido</label>
                            <div class="col-lg-6">
                                <asp:TextBox ID="tbxAlias" class="form-control m-b" placeholder="Alias" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="ibox col">
                                <div class="ibox-title">
                                    <h4><strong>Nutrientes (Em 100g de Alimento)</strong></h4>
                                </div>
                                                                ...
                                                                <asp:Repeater ID="rptNutrientes" runat="server" OnItemCommand="rptNutrientes_ItemCommand"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 15%">
                                                                                <asp:DropDownList ID="ddlUnidade" Style="width: 80px"
                                                                                    runat="server" Enabled="False">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                            <td>
                                                                                <asp:LinkButton ID="lbSalvar" class="form-control" runat="server" CssClass="btn btn-primary-nutrovet" data-toggle="tooltip" data-placement="top" title="Salvar os dados para o item" CommandName="salvar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdNutr") %>'> <i class="fas fa-save"></i></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                            ...
                            <div class="modal-footer col-sm-12 col-lg-12">
                                <div class="btn-group" role="group">
                                    <asp:LinkButton runat="server" ID="lbCancelar" CssClass="btn btn-default" OnClick="lbFechar_Click"> <i class='fas fa-door-open'></i> Fechar </asp:LinkButton>
