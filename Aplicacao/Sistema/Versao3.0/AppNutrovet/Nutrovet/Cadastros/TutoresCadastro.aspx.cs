...
namespace Nutrovet.Cadastros
{
    public partial class TutoresCadastro : System.Web.UI.Page
    {
        ...
        {
            int idAssinante = Funcoes.Funcoes.ConvertePara.Int(User.Identity.Name);

            //Pessoa
            pessoaDcl = new Pessoa
            {
                Nome = tbNomeTutor.Text,
                dTpEntidade = Funcoes.Funcoes.ConvertePara.Int(rblPfPj.SelectedValue),
                IdTpPessoa = (int)DominiosBll.PessoasAuxTipos.Tutor,
                Email = tbEmailTutor.Text
            };
            ...
            switch (Funcoes.Funcoes.ConvertePara.Int(rblPfPj.SelectedValue))
            {
                case 1:
                    {
                        pessoaDcl.CPF = txbCpfCnpj.Text;

                        break;
                    }
                case 2:
                    {
                        pessoaDcl.CNPJ = txbCpfCnpj.Text;
            ...
            pessoaDcl.IdOperador = idAssinante;
            ...
            tutorDcl = new Tutore
            {
                IdCliente = idAssinante,
                Ativo = true,
                IdOperador = idAssinante,
                ...
                case 1:
                    {
                        ...
                        txbCpfCnpj.Attributes["placeholder"] = "CPF";
                        txbCpfCnpj.Attributes["title"] = "CPF do Assinante";
                ...
                case 2:
                    {
                        ...
                        txbCpfCnpj.Attributes["placeholder"] = "CNPJ";
                        txbCpfCnpj.Attributes["title"] = "CNPJ do Assinante";
