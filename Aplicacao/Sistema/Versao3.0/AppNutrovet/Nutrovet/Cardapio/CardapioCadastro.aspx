...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <script>
        function BindEvents() {
            $(document).ready(function () {
                ...
                $('#btnInfoReceit').on('click', function () {
                    $('#modalInfoReceituario').iziModal('open');
                });
                ...
                if ($('#modalInfoReceituario').length) {
                    $('#modalInfoReceituario').iziModal({
                        title: '<i class="fas fa-info-circle"></i> Informação sobre Receituário Inteligente',
                        padding: '20px',
                        headerColor: '#2c3f51',
                        iconColor: 'red',
                        width: '60%',
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:UpdateProgress ID="UpdateProgress" class="divProgress" runat="server" DisplayAfter="500">
                <ProgressTemplate>
                            ...
                            <div id="Tabs" role="tabpanel" class="">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li id="liNutrCard" runat="server" role="presentation">
                                        <asp:LinkButton ID="aNutrCard" class="text-center" runat="server" OnClick="aNutrCard_Click"><i class="fa fa-book"></i>&nbsp;Nutrientes e Receituário</asp:LinkButton>
                                    </li>
                                </ul>
                                        ...
                                        <asp:View ID="tabDadosPaciente" runat="server">
                                            <div class="panel-body">
                                                <div class="ibox-content col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="lblAtual" class="col-lg-2 control-label">Peso Atual (Kg) &nbsp;<asp:Button ID="btnChama" runat="server" class="btn input-buttontotext fa icon-rotate-270" OnClick="btnHistPesoAtual_Click" Text="&#xf080;" data-toggle="tooltip" data-placement="top" title="Histórico Peso Atual" /></label>

                                                        <div class="col-lg-4 input-group" data-toggle="tooltip" data-placement="top" title="Peso Atual">
                                                        ...
                                                        <div class="form-group">
                                                            <label id="lblPesoIdeal" class="col-lg-2 control-label">Peso Ideal (Kg)</label>
                                                            <div class="col-lg-4 input-group" data-toggle="tooltip" data-placement="top" title="Título do Cardápio">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="lblTituloCardapio" class="col-lg-2 control-label">Título</label>
                                                        <div class="col-lg-6 input-group" data-toggle="tooltip" data-placement="top" title="Título do Cardápio">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="lblSugestaoDieta" class="col-lg-2 control-label">Alvo da Dieta</label>
                                                        <div class="col-lg-6 input-group" data-toggle="tooltip" data-placement="top" title="Alvo da Dieta">
                                                            <span class="input-group-addon" style=""><i class="fas fa-balance-scale fa-fw"></i></span>
                                                            <asp:DropDownList ID="ddlSugestaoDieta" runat="server" AutoPostBack="False" class="form-control" data-toggle="tooltip" data-placement="top" title="Alvo da Dieta">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="lblFator" class="col-sm-2 col-lg-2 control-label">Fator</label>
                                                        <div class="col-sm-4 col-lg-4 input-group">
                                                    ...
                                                    <div class="form-group" runat="server" id="divAjuste" visible="false">
                                                        <label id="lblAjuste" class="col-sm-2 col-lg-2 control-label">Ajuste</label>
                                                        <div class="col-sm-4 col-lg-4 input-group">
                                                            <asp:CheckBox ID="cbxAjuste" runat="server" Text="&nbsp;Ajustar Alimentos Mantendo a Proporção?" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="lblNem" class="col-sm-2 col-lg-2 control-label">
                                                            NEM
                                                            <button type="button" id="btnInfoNEM" class="btn input-buttontotext fa" title='Informação sobre Cálculo do NEM'>&#xf05a;</button>
                                                        </label>
                                                        <div class="col-sm-6 col-lg-6 input-group">
                                                            ...
                                                            <div class="modal-dialog modal-notify modal-success modal-dialog-centered" role="document">
                                                                ...
                                                                <div class="modal-content animated flipInY">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        <asp:LinkButton runat="server" ID="btnSim" CssClass="btn btn-primary-nutrovet pull-right" OnClick="btnSim_Click"> <i class='far fa-save'></i>&nbsp;Sim </asp:LinkButton>
                                                                        <asp:LinkButton runat="server" ID="btnNão" CssClass="btn btn-default pull-right" data-dismiss="modal" OnClick="btnNão_Click"> <i class='fas fa-door-open'></i>&nbsp;Não </asp:LinkButton>
                                                                    </div>
                                                                    <!--/Footer-->
                                                                </div>
                                                                <!--/Content-->
                                                    ...
                                                    <div class="col-lg-8 modal-footer ">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="lbSalvar" CssClass="btn btn-primary-nutrovet" OnClick="lbSalvar_Click"><i class="fas fa-hand-point-right"></i>&nbsp;Próximo</asp:LinkButton>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="ibox-content">
                                                                ...
                                                                <div class="flexbox">
                                                                    ...
                                                                    <div class="box col-lg-4">
                                                                        <%--<asp:LinkButton ID="lbIncluirNoCardapio" ToolTip="Incluir no Cardápio" CssClass="btn btn-primary-nutrovet" OnClick="lbFechaListaAlimmentos_Click" runat="server"><i class="fas fa-plus-square"></i></asp:LinkButton>--%>
                                                                        ...
                                                                        <asp:Repeater ID="rptListagemAlimentos" runat="server" OnItemCommand="rptListagemAlimentos_ItemCommand" OnItemDataBound="rptListagemAlimentos_ItemDataBound">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr class="linha-alimento" data-id-alimento="17">
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblBodyAlimento" runat="server" Text='<%# Eval("AlimentoFonte") %>'></asp:Label>
                                                                                    </td>
                                                                                    <td class="text-right">
                                                            ...
                                                            <div class="ibox">
                                                                <div class="ibox-content">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="panel panel-default" id="pnlEM" runat="server">
                                                                                <div class="panel-heading text-center">
                                                                ...
                                                                <div class="pagina-footer col-lg-12 text-left">
                                                                    <div class="text-center">
                                                                ...
                                                                <div class="pagina-footer col-lg-12 text-right">
                                                                    <div class="btn-group" role="group">
                                                                        ...
                                                                        <%--<asp:HyperLink ID="lbImpressaoCardapio" runat="server" title="Impressão do Cardápio" CssClass="btn btn-primary-nutrovet" Target="_self"><i class="fas fa-print"></i> mirmir</asp:HyperLink>--%>
                                                                        <asp:LinkButton ID="btnImpressaoCardapio" runat="server" title="Impressão do Cardápio" CssClass="btn btn-primary-nutrovet" OnClick="btnImpressaoCardapio_Click"><i class="fas fa-print"></i> Impressão</asp:LinkButton>
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="panel-body">
                                                                <div class="ibox-titlePI">
                                                                    <h3 class="no-margins">
                                                                        <asp:Label ID="Label12" runat="server" Text="<i class='fa fa-thumb-tack'></i> Impressão Exigências Nutricionais"></asp:Label>
                                                                ...
                                                                <div class="ibox-content">
                                                                    <div class="form-group">
                                                                        <div class="pull-right">
                                                                            <asp:HyperLink ID="hlImpressaoTbNutr" runat="server" title="Impressão das Exigências Nutricionais" CssClass="btn btn-primary-nutrovet-tai" Target="_blank" Enabled="False"><i class="fas fa-print"></i> impressão</asp:HyperLink>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div  class="ibox-titleZ">
                                                                    <h3 class="no-margins">
                                                                        <asp:Label ID="lblTituloReceituarioInteligente" runat="server" Text="<i class='fa fa-thumb-tack'></i> Receituário Inteligente"></asp:Label>
                                                                        <i class='fa fa-thumb-tack pull-right'></i>
                                                                    </h3>
                                                                </div>
                                                                <div class="col-md-8 col-sm-8 col-lg-8 col-xs-8"></div>
                                                                <div class="ibox-content">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon">
                                                                                    <label id="lblReceituarioInteligente" class="col-lg-0 control-label pull-left">
                                                                                        <button type="button" id="btnInfoReceit" class="btn input-buttontotext fa" title='Informação sobre o Receituário Inteligente'>&#xf05a;</button>
                                                                                    </label>
                                                                                </span>
                                                                                <span class="input-group-addon">
                                                                                    <i class="fas fa-book-medical fa-lg" aria-hidden="true"></i></span>
                                                                                <asp:DropDownList ID="ddlReceituario" runat="Server" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Receituário Inteligente" AutoPostBack="True" OnSelectedIndexChanged="ddlReceituario_SelectedIndexChanged">
                                                                    ...
                                                                    <div id="modalInfoReceituario" style="display: none">
                                                                        <p>O Receituário Inteligente é uma funcionalidade exclusiva para Assinantes do Plano Completo!</p>
                                                                        <p>Se você não possuí esta funcionalidade, poderá fazer um UPGRADE de sua Assinatura através do Menu Minha Conta > Perfil!</p>
                                                                        <p>O Receituário Inteligente é uma ferramenta destinada a elaboração de receitas através da formulação da dieta!</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div id="modalTabelasNutr" runat="server" class="modal-dialog modalControle" style="display: none">
                                                    <div class="modal-content animated fadeIn">
                                                        <div class="modal-header modal-header-success">
                                                            ...
                                                            <h1 class="modal-title"><i class="fa fa-bar-chart fa-1x" aria-hidden="true"></i>
                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    <td colspan="6" class="text-center">
                                                                                        <asp:Label ID="lblTabelaExigNutr" runat="server" Text=""></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
            ...
            <div id="modalReceituario" runat="server" class="modal-dialog modalControle" style="display: none">

                <!--Content-->
                <div class="modal-content fade-in">
                    <!--Header-->
                    <div class="modal-header modal-header-success">
                        <asp:LinkButton runat="server" ID="LinkButton7" CssClass="close" data-dismiss="modal"> <i class='fa fa-times-circle'></i></asp:LinkButton>
                        <h2 class="modal-title"><i class="fa fa-cogs fa-2x" aria-hidden="true"></i>
                            Receituário - Nutracêuticos
                        </h2>
                    </div>

                    <!--Body-->
                    <div class="modal-body" id="content-informacoes-receituario-nutra">
                        <asp:Panel ID="pnlDescricao" runat="server" Height="120px">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12 form-group ">
                                    <asp:Label ID="lblDescricaoReceit" runat="server" Text="Label" Font-Bold="True"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-9 col-lg-9 form-group ">
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:HyperLink ID="hlkReceit" CssClass="btn btn-primary-nutrovet" runat="server" NavigateUrl="~/Perfil/Perfil.aspx">Link para a Tela de Perfil</asp:HyperLink>
                                </div>
                            </div>
                        </asp:Panel>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:LinkButton runat="server" ID="btnFecharReceit" CssClass="btn btn-default" data-dismiss="modal"> <i class='fas fa-door-open'></i> Fechar </asp:LinkButton>
            ...
            <ajaxToolkit:ModalPopupExtender ID="popUpReceituario" runat="server"
                PopupControlID="modalReceituario" BackgroundCssClass="modalBackground"
                RepositionMode="RepositionOnWindowResize"
                TargetControlID="lblPopUpReceit" OkControlID="btnFecharReceit" CancelControlID="btnFecharReceit">
            </ajaxToolkit:ModalPopupExtender>
            <asp:Label ID="lblPopUpReceit" runat="server" Text=""></asp:Label>
            <!-- Central Modal Medium Success-->
    ...
    <div id="modalInfoNEM" style="display: none">
        ...
        <ul style="list-style-type: none">
            <li><i>variante</i> = peso ideal x (24n +12m) x L, onde:</li>
