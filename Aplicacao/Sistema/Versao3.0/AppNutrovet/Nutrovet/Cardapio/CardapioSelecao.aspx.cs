...
namespace Nutrovet.Cardapio
{
    public partial class CardapioSelecao : System.Web.UI.Page
    {
        ...
        private void Copiar(int _id)
        {
            ...
            List<TOCardapioAlimentosBll> listaAlimentos = cardapioAlimentosBll.ListarTO(
                _id, Funcoes.Funcoes.ConvertePara.Int(User.Identity.Name));
                ...
                case ListItemType.AlternatingItem:
                    {
                        ...
                        bool _existeFile = cardapioBll.ExisteArquivoReceita(cardapioTO.Arquivo);

                        hlVisualizar.NavigateUrl = (_existeFile ? _path + cardapioTO.Arquivo : "");
