    ...
    public partial class NutraceuticosCadastro : System.Web.UI.Page
    {
        ...
        private void PopulaTela(int _idNutrac)
        {
            if (_idNutrac > 0)
            {
                ...
                hlTitulo.Text = "<i class=\"fas fa-capsules\"></i> Seleção de Nutracêuticos";
                lblTitulo.Text = "<i class=\"fas fa-capsules\"></i><strong>&nbsp;Alteração de Nutracêuticos</strong>";
            ...
            {
                lblTitulo.Text = "<i class=\"fas fa-capsules\"></i><strong>&nbsp;Inserção de Nutracêuticos</strong>";
                hlTitulo.Text = "Seleção de Nutracêuticos";
