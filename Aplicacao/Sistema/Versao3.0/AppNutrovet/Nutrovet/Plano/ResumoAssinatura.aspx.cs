    ...
    public partial class ResumoAssinatura : System.Web.UI.Page
    {
        ...
        protected void lbAvancarFinalizarAssinatura_Click(object sender, EventArgs e)
        {
            ...
            if (_validaTela.retorno)
            {
                ...
                if (_plano.dPlanoTp == (int)DominiosBll.PlanosAuxTipos.Voucher_30_Dias_Gratuito)
                {
        ...
        private bllRetorno ValidaCampos()
        {
            ...
            if ((_tpPessoa == 1) && (txbCnpjCpfAssinante.Text != "") &&
                (ddlNacionalidadeAssinante.SelectedValue == "1"))
            {
                txbCnpjCpfAssinante.Text = FormataCPF(txbCnpjCpfAssinante.Text);
            }

            if ((_tpPessoa == 2) && (txbCnpjCpfAssinante.Text != "") &&
                (ddlNacionalidadeAssinante.SelectedValue == "2"))
            {
                txbCnpjCpfAssinante.Text = FormataCNPJ(txbCnpjCpfAssinante.Text);
            }
            ...
            else if ((_tpPessoa == 1) && (txbCnpjCpfAssinante.Text == "") && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();

                return
                    bllRetorno.GeraRetorno(false,
                        "Campo CPF deve ser preenchido!");
            }
            else if ((_tpPessoa == 2) && (txbCnpjCpfAssinante.Text == "") && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();
            ...
            else if ((_tpPessoa == 1) && (!rgCpf.IsMatch(txbCnpjCpfAssinante.Text)) && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();
            ...
            else if ((_tpPessoa == 2) && (!rgCnpj.IsMatch(txbCnpjCpfAssinante.Text)) && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();
            ...
            else if ((_tpPessoa == 1) && (!Funcoes.Funcoes.Validacoes.Cpf(txbCnpjCpfAssinante.Text)) && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();
            ...
            else if ((_tpPessoa == 2) && (!Funcoes.Funcoes.Validacoes.Cnpj(txbCnpjCpfAssinante.Text)) && 
                ddlNacionalidadeAssinante.SelectedIndex == 0)
            {
                txbCnpjCpfAssinante.Focus();
            ...
            bllRetorno retornoBll = planoVigenteBll.EhClienteVigente(
                (ddlNacionalidadeAssinante.SelectedValue == "2" ? tbPassaporteAssinante.Text : 
                 txbCnpjCpfAssinante.Text));

            if (retornoBll.retorno)
            {
                retornoBll = planoVigenteBll.JaExisteNomeOuEmail(tbNomeAssinante.Text, tbEmailAssinante.Text);
            }
                ...
                case 1:
                    {
                        switch (ddlNacionalidadeAssinante.SelectedValue)
                        {
                            case "1":
                                {
                                    _dadosComprador.CPF = txbCnpjCpfAssinante.Text;
                ...
                case 2:
                    {
                        _dadosComprador.CPF = "";
                        _dadosComprador.Passaporte = "";
                        _dadosComprador.CNPJ = txbCnpjCpfAssinante.Text;
        ...
        private void PopulaTela()
        {
            if (Session["DadosComprador"] != null)
            {
                ...
                switch (Funcoes.Funcoes.ConvertePara.Int(rblTpPessoa.SelectedValue))
                {
                    case 1:
                        {
                            txbCnpjCpfAssinante.Text = _dadosComprador.CPF;
                            tbDataNascimentoAssinante.Text =
                    ...
                    case 2:
                        {
                            txbCnpjCpfAssinante.Text = _dadosComprador.CNPJ;
                            tbDataNascimentoAssinante.Text = "";
        ...
        protected void btnSim_Click(object sender, EventArgs e)
        {
            ...
            if (Session["DadosComprador"] != null)
            {
                ...
                if (dadosPlano.dPlanoTp != (int)DominiosBll.PlanosAuxTipos.Voucher_30_Dias_Gratuito)
                {
                    ...
                    case 1:
                        {
                            try
                            {
                                ...
                                txbCnpjCpfAssinante.Visible = true;
                    ...
                    case 2:
                        {
                            ...
                            txbCnpjCpfAssinante.Visible = false;
                            ...
                            case 1:
                                {
                                    ...
                                    txbCnpjCpfAssinante.MaxLength = 14;
                                    txbCnpjCpfAssinante.Attributes["placeholder"] = "CPF";
                                    txbCnpjCpfAssinante.Attributes["title"] = "CPF do Assinante";
                            ...
                            case 2:
                                {
                                    ...
                                    txbCnpjCpfAssinante.Attributes["placeholder"] = "CNPJ";
                                    txbCnpjCpfAssinante.Attributes["title"] = "CNPJ do Assinante";
                            ...
                            case 2:
                                {
                                    lbNomeAssinante.Text = "Razão Social";
                                    divDataNascimento.Visible = false;
                                    txbCnpjCpfAssinante.MaxLength = 19;
