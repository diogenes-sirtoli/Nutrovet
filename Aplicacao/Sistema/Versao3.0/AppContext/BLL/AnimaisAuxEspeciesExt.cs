...
namespace BLL
{
    public static class clAnimaisAuxEspeciesExt
    {
            ...
            bool _insersao)
        {
            ...
            else if ((_insersao) && (RegistroDuplicado(_especie.Especie, true)))
            {
                return bllRetorno.GeraRetorno(false, "Esta Espécie já foi Cadastrada!!!");
            }

            if ((_insersao) && (RegistroDuplicado(_especie.Especie, false)))
            {
