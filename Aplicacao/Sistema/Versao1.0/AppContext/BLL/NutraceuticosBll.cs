...
namespace BLL
{
    public class clNutraceuticosBll
    {
        ...
        {
            CrudDal crud = new CrudDal();
            TONutraceuticosBll _retorno = new TONutraceuticosBll();
                ...
                @"SELECT	nutra.IdNutrac, nutra.IdEspecie, e.Especie, n.IdGrupo, 
                    ...
                    FROM    Nutraceuticos AS nutra INNER JOIN
                                ...
                                PrescricaoAuxTipos AS p2 ON nutra.IdPrescr2 = 
                                    p2.IdPrescr
                    WHERE	(nutra.IdNutrac = {0})", _id);

            var ret = crud.ExecutarComando<TONutraceuticosBll>(_sql);
        ...
        public List<TONutraceuticosBll> Listar()
        {
            CrudDal crud = new CrudDal();
        ...
        public List<TONutraceuticosBll> Listar(int _idEspecie)
        {
            ...
            string _sql = string.Format(@"
                ...
                FROM    Nutraceuticos AS nutra INNER JOIN
                            ...
                            PrescricaoAuxTipos AS p2 ON nutra.IdPrescr2 = 
                                p2.IdPrescr
                WHERE   (nutra.Ativo = 1) AND (nutra.IdEspecie = {0})
            ORDER BY e.Especie, n.Nutriente", _idEspecie);
