<%@ Page Title="Nutrologia Veterinária - NutroVET" Language="C#" MasterPageFile="~/AppMenuGeral.Master" AutoEventWireup="true"
    CodeBehind="RacasSelecao.aspx.cs" Inherits="Nutrovet.TabAux.RacasSelecao"
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fas fa-dog fa-flip-horizontal"></i><i class="fas fa-cat"></i><strong>&nbsp;Raças</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row wrapper border-bottom white-bg page-heading">
                            <div class="ibox-content">
                                <div class="search-form">
                                    <div class="input-group col-lg-12">
                                        <asp:TextBox ID="tbPesq" runat="server" placeholder="Pesquisar por Raça" CssClass="form-control input-md bg-muted"></asp:TextBox>
                                ...
                                <div class="ibox-title">
                                    <div class="col-lg-12">
                                        <div class="input-group m-b">
                                            ...
                                            <asp:DropDownList ID="ddlEspecie" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlEspecie_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_content table-responsive col-lg-12">
                                <!-- start project list -->
                                <asp:Repeater ID="rptListagemRaca" runat="server" OnItemCommand="rptListagemRaca_ItemCommand">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th style="width: 15%">
                                                        <asp:Label ID="lblEspecieRaca" runat="server" Text="Espécie"></asp:Label>
                                                    </th>
                                                    <th style="width: 30%">
                                                        <asp:Label ID="lblRaca" runat="server" Text="Raça"></asp:Label>
                                                    </th>
                                                    <th style="width: 13%">
                                                        <asp:Label ID="lblCrescimentoInicial" runat="server" Text="">Cresc. Inicial <sub>(meses)</sub></asp:Label>
                                                    </th>
                                                    <th style="width: 13%">
                                                        <asp:Label ID="lblCrescimentoFinal" runat="server" Text="">Cresc. Final <sub>(meses)</sub></asp:Label>
                                                    </th>
                                                    <th style="width: 13%">
                                                        <asp:Label ID="lblIdadeAdulta" runat="server" Text="">Idade Adulta <sub>(meses)</sub></asp:Label>
                                                    </th>
                                                    <th style="width: 15%" class="text-center">Ação
                                                        <asp:LinkButton ID="lbInserir" runat="server" CommandName="inserir" CssClass="btn btn-primary-nutrovet btn-xs" data-toggle="tooltip" data-placement="top" title="Incluir Raça"><i class="fas fa-plus-square"></i></asp:LinkButton>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblRacaNome" runat="server" Text='<%# Eval("Raca") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblCrescIni" runat="server" Text='<%# Eval("CrescInicial") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblCrescFim" runat="server" Text='<%# Eval("CrescFinal") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblIdAdulta" runat="server" Text='<%# Eval("IdadeAdulta") %>'></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:LinkButton ID="lbEditar" runat="server" CssClass="btn btn-primary-nutrovet btn-xs" CommandName="editar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdRaca") %>' data-toggle="tooltip" data-placement="top" title="Editar Raça"> <i class="fas fa-edit"></i></asp:LinkButton>
                                                <asp:LinkButton ID="lbExcluir" runat="server" CssClass="btn btn-danger btn-xs" CommandName="excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdRaca") %>' TargetControlID="lbExcluir" data-toggle="tooltip" data-placement="top" title="Excluir Raça"><i class="far fa-trash-alt"></i></asp:LinkButton>
                ...
                <div class="modal-dialog modal-notify modal-success modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <label id="lblRaca" class="col-sm-3 control-label">Raça</label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <span class="input-group-addon" style=""><i class="fas fa-bone fa-fw"></i></span>
                                        <asp:TextBox ID="tbxRaca" runat="server" placeholder="Raça" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Raça"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <label id="lblCrescimentoInicialModal" class="col-sm-3 col-lg-3 control-label">Cresc. Inicial</label>
                                <div class="col-sm-5 col-lg-5 form-group">
                                    <cc1:MEdit ID="meCrescInicial" ClientIDMode="Static" runat="server" placeholder="0" CssClass="form-control" data-toggle="tooltip" title="Cresc. Inicial - Preencha a idade final para essa fase" data-placement="top" Mascara="Inteiro"></cc1:MEdit>
                                </div>
                            </div>
                            <div class="row">
                                <label id="lblCrescimentoFinalModal" class="col-sm-3 col-lg-3 control-label">Cresc. Final</label>
                                <div class="col-sm-5 col-lg-5 form-group ">
                                    <cc1:MEdit ID="meCrescFinal" ClientIDMode="Static" runat="server" placeholder="0" CssClass="form-control" data-toggle="tooltip" title="Cresc. Final - Preencha a idade final para essa fase" data-placement="top" Mascara="Inteiro"></cc1:MEdit>
                                </div>
                            </div>
                            <div class="row">
                                <label id="lblIdadeAdultaModal" class="col-sm-3 col-lg-3 control-label">Idade Adulta</label>
                                <div class="col-sm-5 col-lg-5 form-group ">
                                    <cc1:MEdit ID="meIdadeAdulta" ClientIDMode="Static" runat="server" placeholder="0" CssClass="form-control" data-toggle="tooltip" title="Idade Adulta - Preencha a idade inicial para essa fase" data-placement="top" Mascara="Inteiro"></cc1:MEdit>
                                </div>
                            </div>
                            <br />
                        ...
                        <div class="modal-footer ">
                            <asp:LinkButton runat="server" ID="btnSalvar" CssClass="btn btn-sm btn-primary-nutrovet m-t-n-xs" OnClick="btnSalvar_Click"> <i class='far fa-save'></i> Salvar </asp:LinkButton>
                            <asp:LinkButton runat="server" ID="btnFechar" CssClass="btn btn-sm btn-default m-t-n-xs" data-dismiss="modal"> <i class='fas fa-door-open'></i> Fechar </asp:LinkButton>
                        </div>
                    </div>
                    <!--/.Content-->
                </div>
