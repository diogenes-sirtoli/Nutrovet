                ...
                <div class="modal-dialog modal-notify modal-success modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <label id="lblMGrupo" class="col-sm-3 control-label">Grupo de Nutriente</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <label id="lblMOrdem" class="col-sm-3 col-lg-3 control-label">Ordem</label>
                            ...
                            <div class="row">
                                <label id="lblMListar" class="col-sm-3 col-lg-3 control-label">Listar no Cadastro de Alimentos?</label>
                                <div class="col-sm-5 col-lg-5 form-group ">
