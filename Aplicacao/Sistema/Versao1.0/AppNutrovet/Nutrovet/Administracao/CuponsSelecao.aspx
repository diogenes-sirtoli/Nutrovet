                    ...
                    <div class="col-lg-12">
                        <div class="row wrapper border-bottom white-bg page-heading">
                            <div class="ibox-content">
                                <div class="search-form">
                                    <div class="input-group col-lg-12">
                                        <asp:TextBox ID="tbPesq" runat="server" placeholder="Pesquisar por Cupom" CssClass="form-control input-md bg-muted"></asp:TextBox>
                            ...
                            <div class="x_content table-responsive col-lg-12">
                                <!-- start project list -->
                                <asp:Repeater ID="rptCupom" runat="server" OnItemCommand="rptCupom_ItemCommand">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th style="width: 5%">
                                                        <asp:Label ID="lblTNrCupom" runat="server" Text="Nº Cupom"></asp:Label>
                                                    </th>
                                                    <th style="width: 15%">
                                                        <asp:Label ID="lblTTipoDesconto" runat="server" Text="Tipo Desconto"></asp:Label>
                                                    </th>
                                                    <th style="width: 15%"  class="text-center">
                                                        <asp:Label ID="lblTValorDesconto" runat="server" Text="Valor Desconto"></asp:Label>
                                                    </th>
                                                    <th style="width: 15%"  class="text-center">
                                                        <asp:Label ID="lblTDtInicio" runat="server" Text="Data Início"></asp:Label>
                                                    </th>
                                                    <th style="width: 15%"  class="text-center">
                                                        <asp:Label ID="lblTDtFim" runat="server" Text="Data Fim"></asp:Label>
                                                    </th>
                                                    <th style="width: 15%"  class="text-center">
                                                        <asp:Label ID="lblTUsado" runat="server" Text="Utilizado"></asp:Label>
                                                    </th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblLNrCupom" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblTTIpoDesconto" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblTValorDesconto" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblLDtInicio" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblLDtFim" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:Label ID="lblLUsado" runat="server" Text=''></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <asp:LinkButton ID="lbEditar" runat="server" CssClass="btn btn-primary-nutrovet btn-xs"><i class="fas fa-edit"></i></asp:LinkButton>
                                                <asp:LinkButton ID="lbExcluir" runat="server" CssClass="btn btn-danger btn-xs" CommandName="excluir" TargetControlID="lbExcluir"><i class="far fa-trash-alt" data-toggle="tooltip" data-placement="top" title="Excluir Cupom"></i></asp:LinkButton>
                ...
                <div class="modal-dialog modal-notify modal-success modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <label id="lblRaca" class="col-sm-3 control-label">Nutriente</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <label id="lblCrescimentoInicialModal" class="col-sm-3 col-lg-3 control-label">Grupo</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-group "></div>
                                <label id="lblCrescimentoFinalModal" class="col-sm-3 col-lg-3 control-label">Unidade</label>
                                <div class="col-sm-5 col-lg-5 form-group ">
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-group "></div>
                                <label id="Labe5" class="col-sm-3 col-lg-3 control-label">Listar em Alimentos?</label>
                                <div class="col-sm-5 col-lg-5 form-group ">
                                    <asp:Button ID="btnSim" runat="server" CssClass="btn btn-default" Text="Sim"  />
                                    <asp:Button ID="btnNao" runat="server" CssClass="btn btn-primary-nutrovet" Text="Não"  />
                                </div>
                            </div>
                            <br />
                        ...
                        <div class="modal-footer ">
                            <asp:LinkButton runat="server" ID="btnSalvar" CssClass="btn btn-sm btn-primary-nutrovet m-t-n-xs" > <i class='far fa-save'></i> Salvar </asp:LinkButton>
