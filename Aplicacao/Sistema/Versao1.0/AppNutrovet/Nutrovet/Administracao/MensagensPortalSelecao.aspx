                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        ...
                        <div class="col-lg-4">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fas fa-user"></i><strong>&nbsp;Mensagens</strong>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div id="modalEnvaiEmail" runat="server" style="display: none">
                <div class="modal-dialog modal-notify modal-success modal-dialog-centered" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <!--Footer-->
                        <div class="modal-footer ">
                            <asp:LinkButton runat="server" ID="lbEnviar" CssClass="btn btn-sm btn-default m-t-n-xs" OnClick="lbEnviar_Click"><i class='far fa-envelope'></i> Enviar </asp:LinkButton>
                            &nbsp;
                            <asp:LinkButton runat="server" ID="LinkButton2" CssClass="btn btn-sm btn-default m-t-n-xs" data-dismiss="modal"> <i class='fas fa-door-open'></i> Fechar </asp:LinkButton>
                        </div>
                    </div>
                    <!--/.Content-->
                </div>
