    ...
    public partial class CardapioCadastro : System.Web.UI.Page
    {
        ...
        private void PopularTutor(int _idPessoa)
        {
            List<TOPessoasBll> listagem = pessoaBll.CachePessoas().
                Where(p => p.IdCliente == _idPessoa).ToList();
        ...
        private void PopularDietas()
        {
            List<TODietasBll> listagem = dietasBll.Listar();
        ...
        private void PopulaDadosPaciente(int idCardapio)
        {
            ...
            if (Funcoes.Funcoes.ConvertePara.Int(cardapioDcl.IdAnimal) > 0)
            {
                ...
                Funcoes.Funcoes.ControlForm.SetComboBox(ddlTutor, animaisDcl.IdPessoa);
                PopulaPaciente(animaisDcl.IdPessoa);
        ...
        {
            ltbAlimentos.DataTextField = "Alimento";
        ...
        protected void rptResumoCardapio_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
                ...
                (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                TOCardapioResumoBll Totais =
                    (TOCardapioResumoBll)Session["cardAlimTotais"] != null ?
                    (TOCardapioResumoBll)Session["cardAlimTotais"] :
                    new TOCardapioResumoBll();
        ...
        {
            cardapioDcl = cardapioBll.Carregar(Funcoes.Funcoes.ConvertePara.Int(
                            Funcoes.Funcoes.Seguranca.Descriptografar(
                                Funcoes.Funcoes.ConvertePara.String(
                                    Request.QueryString["_idCardapio"]))));
            ...
            List<AnimaisPesoHistorico> listagem = animaisBll.GeraGrafico(Funcoes.Funcoes.ConvertePara.Int(
                cardapioDcl.IdAnimal), _ini, _fim);
