...
namespace Nutrovet.Cardapio
{
    public partial class CardapioSelecao : System.Web.UI.Page
    {
        ...
        protected clPessoasBll tutoresBll = new clPessoasBll();
        ...
        {
            List<TOPessoasBll> listagem = tutoresBll.CachePessoas().
        ...
        private void PopularAnimais(int _idPessoa)
        {
            ddlAnimais.DataTextField = "Animal";
            ddlAnimais.DataValueField = "IdAnimal";
            ddlAnimais.DataSource = animaisBll.Listar(_idPessoa);
            ddlAnimais.DataBind();
