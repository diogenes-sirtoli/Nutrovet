...
escolha o fator e após selecione os cardápios." OnClick="btnBalDieta_Click" Enabled="False"><i class="fas fa-weight"></i></asp:LinkButton>
                                    ...
                                    <table class="table table-striped table-hover dataTables-cardapios">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 5%">
                                                    <%--<asp:Label ID="lblCbxBalDiet" runat="server" Text="Bal. Dieta" Visible="False"></asp:Label>--%>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <asp:LinkButton ID="lbCopiar" runat="server" CssClass="btn btn-warning btn-xs" CommandName="copiar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IdCardapio") %>' data-toggle="tooltip" data-placement="top" title="Copiar Cardápio"> <i class="fas fa-paste"></i></asp:LinkButton>
                                    ...
                                    <div class="ibox float-e-margins">
                                        <div class="row wrapper border-bottom white-bg page-heading">
                                            ...
                                            <div class="col-lg-8 text-right">
                                                <asp:LinkButton runat="server" ID="lbPagPrimeira" CssClass="btn btn-dafault" ToolTip="Primeira" OnClick="lbPagPrimeira_Click"> <i class='fa fa-backward'></i> </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lbAnt" CssClass="btn btn-dafault" Visible="False" OnClick="lbAnt_Click" ToolTip="Anterior"><i class='fa fa-step-backward'></i></asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lb1" CssClass="btn btn-dafault" CommandName="1" OnClick="lb1_Click"> <b><u>1</u></b> </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lb2" CssClass="btn btn-dafault" CommandName="2" OnClick="lb2_Click"> 2 </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lb3" CssClass="btn btn-dafault" CommandName="3" OnClick="lb3_Click"> 3 </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lb4" CssClass="btn btn-dafault" CommandName="4" OnClick="lb4_Click"> 4 </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lb5" CssClass="btn btn-dafault" CommandName="5" OnClick="lb5_Click"> 5 </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lbPost" CssClass="btn btn-dafault" ToolTip="Próxima" OnClick="lbPost_Click"><i class='fa fa-step-forward'></i></asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="lbPagUltima" CssClass="btn btn-dafault" ToolTip="Última" OnClick="lbPagUltima_Click"> <i class='fa fa-forward'></i> </asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
