...
<body id="home">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li><a data-toggle="collapse" data-target=".in" href="PortalNutrovet.aspx"><i class="fa fa-home"></i>&nbsp;Início</a></li>
                        <li><a data-toggle="collapse" data-target=".in" href="#features"><i class="fas fa-clipboard-list"></i>&nbsp;Funcionalidades</a></li>
                        <li><a data-toggle="collapse" data-target=".in" href="#about"><i class="fas fa-desktop"></i>&nbsp;O Sistema</a></li>
                        <li><a data-toggle="collapse" data-target=".in" href="#contact-us"><i class="fa fa-envelope"></i>&nbsp;Contato</a></li>
                        <li><a data-toggle="collapse" data-target=".in" href="Plano/EscolherPlano.aspx"><i class="fas fa-handshake"></i>&nbsp;Planos</a></li>
                        <li><a data-toggle="collapse" data-target=".in" href="Login.aspx"><i class="fab fa-expeditedssl"></i>&nbsp;Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <section id="hero-banner">
        <img src="Imagens/banner/nut970.png" id="centralizar" alt="NutroVET" />
    </section>
    <!--/#main-slider-->
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <section id="about">
                    <div class="container">
                        ...
                        <div class="container">
                            ...
                            <p class="text-right to-animate"><a href="./Plano/EscolherPlano.aspx" class="btn btn-primaryS btn-outline"><i class="fas fa-handshake"></i>&nbsp;Assine Agora</a></p>
                ...
                <section id="business-stats" style="background-color: #ffffff;">
                    <div class="container">
                        <div class="section-header">
                ...
                <section id="contact-us" style="background: #222;">
                    <div class="container">
                        <div class="section-header">
