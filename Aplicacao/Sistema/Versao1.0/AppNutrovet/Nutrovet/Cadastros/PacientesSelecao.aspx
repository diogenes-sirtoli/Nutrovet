                                ...
                                <div class="ibox-content">
                                    <div class="search-form">
                                        <div class="input-group col-lg-12">
                                            <asp:TextBox ID="tbPesq" runat="server" placeholder="Pesquisar por Paciente" CssClass="form-control input-md bg-muted"></asp:TextBox>
                                ...
                                <div class="x_content table-responsive">
                                    ...
                                    <asp:Repeater ID="rptAnimais" runat="server" OnItemCommand="rptAnimais_ItemCommand">
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                <td>
                                                    <asp:Label ID="lblTutor" runat="server" Text='<%# Eval("Nome") %>'></asp:Label>
                                                </td>
                                                <td>
