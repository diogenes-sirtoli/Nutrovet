                                            ...
                                            <div class="thumbnail">
                                                <div class="caption">
                                                    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 well well-add-card'>
                                                        ...
                                                        <b>
                                                            <h3><asp:Label ID="lblNomeAssinanteRegistro" style="color:#1A1A40;" runat="server" Text='<%# Eval("Nome") %>' data-toggle="tooltip" data-placement="top" TextMode="SingleLine" title="Nome do Assinante"></asp:Label></h3>
                                                        </b>
                                                    </div>
