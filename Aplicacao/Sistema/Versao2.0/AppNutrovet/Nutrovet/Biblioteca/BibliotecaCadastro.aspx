                                                                                    ...
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style="width: 10%" colspan="2">
                                                                                                <asp:Label ID="Label4" Style="color: #2c3f51" runat="server" Text="Ação"></asp:Label>
                                                                                            </th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody>
            ...
            <div id="modalInserirArquivoSecao" runat="server" class="modal-dialog modalControle" style="display: none">
                ...
                <div class="modal-content animated fadeIn">
                    ...
                    <div class="modal-footer ">
                        <asp:LinkButton runat="server" ID="btnFecharInserirArquivoSecao" CssClass="btn btn-default" data-dismiss="modal"> <i class='fas fa-door-open'></i> Fechar </asp:LinkButton>
                        <asp:LinkButton runat="server" ID="btnSalvarInserirArquivoSecao" CssClass="btn btn-primary-nutrovet" OnClick="btnSalvarInserirArquivoSecao_Click"> <i class='far fa-save'></i> Salvar </asp:LinkButton>
                    </div>
                </div>
                <!--/.Content-->
            </div>
