                                                        ...
                                                        <div class="ibox float-e-margins">
                                                            <div class="ibox">
                                                                ...
                                                                <div class="pagina-footer col-lg-12 text-right">
                                                                    ...
                                                                    <asp:HyperLink ID="lbImpressaoCardapio" runat="server" title="Impressão do Cardápio" CssClass="btn btn-default" Target="_blank"><i class="fas fa-print"></i> imprimir</asp:HyperLink>
                                            ...
                                            <div>
                                                <div class="x_content table-responsive">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="form-group">
                                                                <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-8 pull-left">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon" style="visibility: hidden"><i class="fas fa-book-medical fa-lg" aria-hidden="true"></i></span>
                                                                        <asp:DropDownList ID="ddlReceituario" runat="Server" CssClass="form-control" data-toggle="tooltip" data-placement="top" title="Receituário Inteligente" AutoPostBack="True" OnSelectedIndexChanged="ddlReceituario_SelectedIndexChanged" Visible="False">
                                                                ...
                                                                <label id="lblReceituarioInteligente" class="col-lg-0 control-label pull-left" style="visibility: hidden">
                                                                ...
                                                                <div id="modalInfoReceituario" style="display: none">
                                                                    <p>O Receituário Inteligente é uma funcionalidade exclusiva para Assinantes dos Planos Intermediário e Completo!</p>
                                                                ...
                                                                <div class="pull-right">
                                                                    <asp:HyperLink ID="hlImpressaoTbNutr" runat="server" title="Impressão das Exigências Nutricionais" CssClass="btn btn-primary-nutrovet-tai" Target="_blank" Enabled="False"><i class="fas fa-print"></i> imprimir</asp:HyperLink>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
