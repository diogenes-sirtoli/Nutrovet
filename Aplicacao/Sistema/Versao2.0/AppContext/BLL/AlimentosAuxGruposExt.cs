...
namespace BLL
{
    public static class clAlimentosAuxGruposExt
    {
            ...
            bool _insersao)
        {
            ...
            else if ((_insersao) && (RegistroDuplicado(_grupo.GrupoAlimento, true)))
            {
                return bllRetorno.GeraRetorno(false, 
                    "Este Grupo de Alimentos já foi Cadastrado!!!");
            }

            if ((_insersao) && (RegistroDuplicado(_grupo.GrupoAlimento, false)))
            {
