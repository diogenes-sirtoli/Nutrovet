	...
	public class clConfigReceituarioBll
    {
		...
		public ConfigReceituario Carregar(int _id)
		{
			...
			string _sql = string.Format(
                @"SELECT	IdPessoa, NomeClinica, Slogan, Site, Facebook, 
							Twitter, Instagram, Logotipo, Assinatura, CRMV,
                            CrmvUf, Email, Telefone, Celular, Logradouro, 
                            Logr_Nr, Logr_Compl, Logr_Bairro, Logr_CEP, 
                            Logr_Cidade, Logr_UF, Logr_Pais, Ativo, 
