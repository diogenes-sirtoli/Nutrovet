...
namespace BLL
{
    public class clLogsSistemaBll
    {
        ...
        public LogsSistema Carregar(int _id)
        {
            ...
            LogsSistema _log = null;

            var consulta = crud.ExecutarComando<LogsSistema>(string.Format(@"
                Select *
                From LogsSistema
                Where (IdLog = {0})", _id));
        ...
        public bllRetorno Excluir(LogsSistema _log)
        {
            CrudDal crud = new CrudDal();
            bllRetorno msg;
        ...
        public List<TOLogsSistemaBll> Listar()
        {
            ...
            var lista = crud.Listar<TOLogsSistemaBll>(_sql);
