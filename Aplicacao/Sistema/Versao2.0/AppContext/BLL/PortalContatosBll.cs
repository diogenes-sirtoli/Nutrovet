...
namespace BLL
{
    public class clPortalContatosBll
    {
            ...
            string _assunto, string _texto)
        {
            ...
            Funcoes.Funcoes.EMail.EmailDe = _de;// "contato@nutrovet.com.br";
            ...
            Funcoes.Funcoes.EMail.SMTP = "server18.mailgrid.com.br";//"dedrelay.secureserver.net";
            Funcoes.Funcoes.EMail.Porta = 25;
            Funcoes.Funcoes.EMail.Conta = "contato@nutrovet.com.br";
            Funcoes.Funcoes.EMail.Senha = "4zjwic619fca";//"m@r5ped9";
